...
// Generate next month's bookings, then send each customer one email with the
// ending month's invoice and next month's schedule. In test mode every email
// is delivered to the shop's own inbox instead of to customers.
//
