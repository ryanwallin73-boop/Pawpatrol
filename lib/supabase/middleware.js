...
export async function updateSession(request) {
  ...
  // Routes reachable without a staff login: the login page and the
  // customer-facing signup form (+ its submit endpoint).
  const publicPrefixes = ["/login", "/signup", "/api/signup"];
